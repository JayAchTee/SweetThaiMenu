...
$(function ()
{
	//	This is a Handlebars Helper to format valus as a currency 
	...
	//	Register the Order Item Partial template for creating order rows 
	Handlebars.registerPartial("orderItem", $("#order-item-template").html());
